...
import com.contactpigeon.fbsdkconsumerplugin.PrefUtils;
...
//        printMsg(String.format("isPushActive:%b",false));
    ...
    public void askforregistration(String token) {
